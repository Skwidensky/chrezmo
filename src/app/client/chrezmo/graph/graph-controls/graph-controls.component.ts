import { AfterViewInit, Component, OnInit, ViewChild, ViewChildren, ElementRef } from '@angular/core';
...
export class GraphControlsComponent implements AfterViewInit {
  ...
  private initEvtListeners(): void {
    ...
    this.state.makeQueryObs().subscribe(() => {
      this.makeQuery();
    });
